...
1. `.agents/skills/interface-design/SKILL.md` or `~/.gemini/antigravity/skills/interface-design/SKILL.md` — the foundation, principles, craft knowledge, and checks
...
2. Check if `.interface-design/system.md` exists at the workspace root
